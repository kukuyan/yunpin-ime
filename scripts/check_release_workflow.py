...
CI_SNIPPETS = {
    ...
    "python3 -m unittest tests.test_grammar_model_recovery -v": "locked model recovery tests",
    "run: python scripts/restore_grammar_model.py": "Windows immutable model recovery",
    "run: python3 scripts/restore_grammar_model.py": "macOS immutable model recovery",
